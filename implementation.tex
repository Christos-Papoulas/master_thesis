...
This part of the thesis describes the User Interface of Social Network Platform that is implementated based on 104 mock-ups created by HCI expert team. The design of look \& feel of SNP is made by HCI expert team in order to follow the modern trends in Web Applications design. In order to support those look \& feel and the functionality of those mock-ups 25K lines of php, js and css code is written.
