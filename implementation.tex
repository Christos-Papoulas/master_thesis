...
For example, one real question from the StackOverflow is shown in figure~\ref{fig:so_question}, which is asks the community about the scalability of SQLite and MySQL. From this specific question several important outcomes can be mined. First, this question is very difficult to answered without the presence of real data from execution histories of those applications. Second, similar questions can be asked to our own social networking community and would be helpful to use it as a training set to our topic classification tool presented in this section. Finally, a lot of this type of questions exist in StackOverflow community and we would like to get touch with them and use them for classification.
