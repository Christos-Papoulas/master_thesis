...
The PaaSage Social Network integrates memcached in its back-end architecture and it was configured to properly interact with the caching application.


\subsection{Professional Networks} 
This subsection reviews the related work on professional social networks. The table~\ref{tab:related} summarizes
...
histories; and whether these repositories are communitysourced;
...
\subsubsection{Configuration management and deployment}
...
The Natural Language Processing (NLP)~\cite{manning1999foundations} has been used in several aspects of computer science. We focus on social networking usage of NLP and how knowledge can be mined from repositories of Q\&A sites. 
