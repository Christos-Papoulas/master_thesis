...
IT professionals use a variety of online sources as aids in their daily tasks. Developers typically prefer community-moderated forums over vendor-moderated sites.%~\cite{evans-date}
...
\cline{2-10}
  &  \multicolumn{4}{c|}{Interaction Between Users} & \multicolumn{5}{c|}{Repository} &  &  \\ 
\cline{2-12} 
  &
   
  \begin{tabular}[c]{@{}c@{}}\rot{Social features \tnote{a}} \end{tabular} & 
  \begin{tabular}{c@{\hskip 0.1in}} \rot{Groups}\end{tabular} & 
  \begin{tabular}{c} \rot{Q \& A} \end{tabular} & 
